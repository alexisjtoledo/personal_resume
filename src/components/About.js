    ...
    render() {
        return (
            ...
            <div className="main-article" id="about">
                ...
                <p>I'm a <strong>Front End Developer</strong> and <strong>Graphic Designer</strong> from Argentina based in Copenhaguen, Denmark. I have more than 8 years of experience in graphic design and designing responsive web sites and web apps with HTML5, CSS3, and JS. I have experience working in most of the stages of web development and in solving problems.</p> 
                ...
                <br/>
                <a href="https://drive.google.com/open?id=1YOGNvZfghGoJIgtOmxk8qQpVVb077xG2" target="_blank" rel="noopener noreferrer" className="no-link">
